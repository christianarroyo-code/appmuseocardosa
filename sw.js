const CACHE = 'museo-cardosa-v3';
const ASSETS = [
  './index.html',
  './manifest.json',
  './vendor/firebase-ai.bundle.js',
...
self.addEventListener('fetch', (e) => {
  ...
  // El análisis con Gemini va directo desde el navegador a Firebase, no pasa
  // por este service worker (es una petición cross-origin a Google).
